...
import { View,Swiper,SwiperItem,Text, Button,ScrollView,Image } from '@tarojs/components'
import './index.scss'
...
export default class Home extends Component {
  ...
  onConfirm = () =>{
    ...
    Taro.navigateTo({
      url:`/pages/searchRes/index?keyWord=${value}`
    })
  ...
  onPullDownRefresh() {
    ...
    // console.log(testLists[0].goodHead.url)
  ...
  render () {
    ...
    if(!testLists[0] || !testLists[1] || !testLists[2]){
      return (
        ...
        <ScrollView className='home-container'>
          {/* <View style='width:100%;height:900px;background-color: #fff;' > */}
            ...
            <Swiper
              ...
              <SwiperItem>
                <View className='ban1'>
                  <Image className='swiperImg' mode='scaleToFill' src={testLists[3].goodHead.url} onClick={this.toGoodDetails.bind(this,testLists[3].objectId)}/>
                </View>
              </SwiperItem>
              <SwiperItem>
                <View className='ban1'>
                  <Image className='swiperImg' mode='heightFix' src={testLists[1].goodHead.url} onClick={this.toGoodDetails.bind(this,testLists[1].objectId)}/>
                </View>
              </SwiperItem>
              <SwiperItem>
                <View className='ban1'>
                  <Image className='swiperImg' mode='heightFix' src={testLists[0].goodHead.url} onClick={this.toGoodDetails.bind(this,testLists[0].objectId)}/>
                </View>
              </SwiperItem>
            </Swiper>
            <View className='homeCategory'>
